...
\begin{tabular}{p{0.6\columnwidth} p{0.2\columnwidth}}
\hline\noalign{\smallskip}
...
Then, Section \ref{ResearchGoals} presents our research objective and research questions. After that, in section \ref{methodology} presents how data gathering, statistical modeling, and qualitative analysis are proposed to be done, as well as our initial hypotheses. Section \ref{YetToBeDone} presents the work that needs to be done. Section \ref{timelineSection}, shows the proposed timeline for the research. Lastly, section \ref{threatsToValidity} the threats to validity are discussed. \\
\pagebreak
...
To validate what our quantitative approach finds, and to account and check for possible confounding factors, we will interview and survey people from the studied forked projects. 
We will also analyze the sentiments in the content of the messages send and received by the top contributors of the project in the month leading to the forking events will be analyzed.
...
\begin{figure}[!ht]
\centering
\epsfig{file=epc-flow-charts.pdf, width=1.3\columnwidth}
...
\begin{figure}[!ht]
\centering
\epsfig{file=flowchart.eps, width=0.9\columnwidth}
...
% \node[state,
% below of=Model,
% node distance=1cm, yshift=-1.25cm, xshift = 3cm] (MANOVA) 
% {%
% \begin{tabular}{l}
...
% \node[state,
% below of=MANOVA,
% node distance=1cm, yshift=-2.5cm, xshift = 1cm] (Results) 
% {%
% \begin{tabular}{l}
%  \textbf{Results}\\
%  \parbox{8cm}{
...
% \path 
%(Data Collection) edge[bend right=-40]
...
\begin{itemize}
\item (Covariate V1) Developer's level of contribution/activity (e.g. code commits per month, or mailing list posts per month)
\item (Covariate V2) Developer's level of privilege/prestige (e.g. admin privilege-holder vs. core contributor vs. marginal developer/user)
\item (Covariate V3) Developer's level of negative experience (e.g. number of rejected pull requests: especially in forks for more community-driven development)
\item (Covariate V4) Developer's age (either birth age, (young 20-year-old developer vs. older 50-year-old developer) or their seniority as a development community member (i.e. how long they have been in the community)
\item (Covariate V5) Developer's propensity for short-responses vs. long-responses. (under-communicator vs. over-communicator)
\item (Covariate V6) Developer's communication sentiment (generally bitter in communication known as ``a jerk'', or has a positive communication prose)
\item (Covariate V7) Developer's engagement style (i.e. dive-bomber-style contributor who jumps in, overcommits and leave, vs. a steady and increasingly engaged contributor who starts off slow and grows his/her commitment gradually)
\end{itemize}
...
A summary of expectation for model effect, based on intuition, is summarized in Table \ref{tabelSummaryExpectationModelParameters}. 

\begin{table*}[p]
\centering
\caption{Expectations for significance of the statistical model covariates based on intuition. Note that * indicates significantly-related; +/- indicates positively/negatively related.}
\label{tabelSummaryExpectationModelParameters}       
\begin{tabular}{m{0.6\columnwidth} m{0.12\columnwidth} m{0.1\columnwidth} m{0.1\columnwidth} m{0.01\columnwidth}}
\hline\noalign{\smallskip}
%\textbf{Model parameter} & \textbf{U.F. Pers. Dif.} & \textbf{U.F. More Comm.} & \textbf{H.F. Tech. Dif.} & \textbf{No.F.}\\
\textbf{Model parameter} & \textbf{U.F. Pers. Dif.} & \textbf{U.F. More Comm.} & \textbf{H.F. Tech. Dif.} & \\

\noalign{\smallskip}\hline\noalign{\smallskip}
Reciprocity  & * &  & * &  \\ \hline
Transitive triplets & * &  & *  &   \\ \hline
Number of developers at distance two &  & *- &  &  \\ \hline
Three-cycles  & * &  & * &  \\ \hline
out-out degree assortativity &  & *+ &  &  \\ \hline
\small{Covariate-V1 [Developer's contribution level]-related popularity} & * &  & * &  \\ \hline
\small{Covariate-V2 [Developer's privilege level]-related dissimilarity} &  & *- & * &  \\ \hline

\small{Covariate-V3 [Developer's negative experience level]-related  popularity}  &  & * &  &  \\ \hline
\small{Covariate-V3 [Developer's negative experience level]-related  dissimilarity}  & * &  &  &  \\ \hline

\small{Covariate-V4 [Developer's age-seniority level]-related   popularity}  & * &  &  &  \\ \hline
\small{Covariate-V4 [Developer's age-seniority level]-related   dissimilarity}  & * & * &  &  \\ \hline

\small{Covariate-V5 and V6[Developer's under/over communicator \& sentiment history]-related activity and dissimilarity}  & * &  &  &  \\ \hline
%\small{Covariate-V5[Developer's under/over communicator]-related dissimilarity}  & * &  &  &  \\ \hline

%\small{Covariate-V6 [Developer's sentiment history]-related activity}  & * &  &  &  \\ \hline
%\small{Covariate-V6 [Developer's sentiment history]-related dissimilarity}  & * &  &  &  \\ \hline

\small{Covariate-V7 [Developer's graduality level]-related activity} & * & *- &  &  \\ \hline
\small{Covariate-V7 [Developer's graduality level]-related dissimilarity} & * & *- &  &  \\
\noalign{\smallskip}\hline
\end{tabular}
\end{table*}
...
The time series shown in Figures \ref{figureTS_1to6} and \ref{figureTS_7to12} show the daily average sentiments of the developers' messages.

\begin{figure}[!htbp]
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_1.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_2.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_3.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_4.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_5.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_6.pdf, width=0.55\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_7.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_8.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_9.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_10.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_11.pdf, width=0.55\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/TS_12.pdf, width=0.55\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_1.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_2.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_3.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_4.pdf, width=0.57\columnwidth}
\caption{Time series decomposed into trend, seasonality and noise time Series for projects (From top to bottom, left to right) Kamailio, ffmpeg, Amarok, Apache CouchDB.}
\label{figureDecpmposed_1to4}
\end{figure}

\begin{figure}[!htbp]
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_5.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_6.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_7.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_8.pdf, width=0.57\columnwidth}
\caption{Time series decomposed into trend, seasonality and noise time Series for projects (From top to bottom, left to right) Pidgin, MPlayer, Asterisk, rdesktop.}
\label{figureDecpmposed_5to8}
\end{figure}


\begin{figure}[!htbp]
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_9.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_10.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_11.pdf, width=0.57\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/D_12.pdf, width=0.57\columnwidth}
\caption{Time series decomposed into trend, seasonality and noise time Series for projects (From top to bottom, left to right) freeglut, Ceph, OpenStack Neutron, and GlusterFS}
...
\begin{figure}[!htbp]
\centering
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_1.pdf, width=0.7\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_2.pdf, width=0.7\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_3.pdf, width=0.7\columnwidth}
...
\begin{figure}[!htbp]
\centering
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_5.pdf, width=0.6\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_6.pdf, width=0.6\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_7.pdf, width=0.6\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_9.pdf, width=0.6\columnwidth}
...
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_10.pdf, width=0.7\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_11.pdf, width=0.7\columnwidth}
\epsfig{file=/home/aha/Desktop/Thesis_data/prelim/PLOTS_PDF/O_12.pdf, width=0.7\columnwidth}
...
All the following description from \cite{Chen} describes outlier models. For an ARIMA($p, d, q$) process, we have 
...
Project 1
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_1.tex}\\

Project 2
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_2.tex}\\

Project 3
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_3.tex}\\

Project 4: No outliers detected. \\
%\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_4.tex}\\
%
Project 5
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_5.tex}\\

Project 6
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_6.tex}\\

Project 7
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_7.tex}\\

%Project 8
%\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_8.tex}\\

Project 9
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_9.tex}\\

Project 10
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_10.tex}\\

Project 11
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_11.tex}\\

Project 12
\input{/home/aha/Desktop/OUTPUTS/SENTIMENTS_OUTPUTS/R_Environment_Variables/outlier_table_12.tex}\\
...
\subsubsection{Qualitative Study: Interviews and Survey}
...
To test and validate our quantitative findings, we will model projects with ``unknown'' (or treated as ``unknown'') forking history using the same longitudinal modeling method. 
...
\captionof{table}{Estimates parameters in the model for Project Kamailio}   % Table based on sienaFit object ans
...
\captionof{table}{Estimates parameters in the model for Project ffmpeg}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project Amarok}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
\hline
\rule{0pt}{2ex}\relax
Rate 1 & 1 & 29 & (0 & 33) & \omit & -\\
Rate 2 & 2 & 15 & (0 & 63) & \omit & -\\
Rate 3 & 2 & 12 & (0 & 63) & \omit & -\\
Rate 4 & 5 & 09 & (1 & 79) & \omit & -\\
Rate 5 & 3 & 96 & (1 & 16) & \omit & -\\
Rate 6 & 6 & 21 & (2 & 27) & \omit & -\\
Rate 7 & 1 & 57 & (0 & 39) & \omit & -\\
Rate 8 & 0 & 62 & (0 & 20) & \omit & -\\
Rate 9 & 0 & 68 & (0 & 21) & \omit & -\\
\hline
\rule{0pt}{2ex}\relax
outdegree (density)                        & --4 & 33$^{\ast\ast\ast}$ & ( 0 & 25) & --17 & 21\\
reciprocity                                & --3 & 47                  & ( 6 & 23) &  --0 & 56\\
transitive triplets                        &   2 & 91$^{\ast\ast\ast}$ & ( 0 & 85) &    3 & 42\\
3-cycles                                   & --2 & 58                  & ( 8 & 58) &  --0 & 30\\
out-out degree\^(1/2) assortativity         &   0 & 14                  & ( 0 & 38) &    0 & 37\\
devSeniority alter                         & --0 & 00                  & ( 0 & 00) &  --1 & 01\\
devSeniority ego                           &   0 & 00                  & ( 0 & 00) &    1 & 37\\
devSeniority ego x devSeniority alter      &   0 & 00                  & (31 & 61) &    0 & 00\\
devScActivity alter                        & --0 & 01                  & ( 0 & 01) &  --1 & 02\\
devScActivity ego                          &   0 & 01$^{\ast\ast}$     & ( 0 & 01) &    2 & 79\\
...
\multicolumn{5}{l}
   {\footnotesize{convergence $t$ ratios all $<$ 1.3,}}\\
\multicolumn{5}{l}{\footnotesize{overall maximum convergence ratio 2.03.}}
\label{ans3}
\end{tabular}


\captionof{table}{Estimates parameters in the model for Project Apache CouchDB}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
\hline
\rule{0pt}{2ex}\relax
Rate 1 & 1 & 31 & (0 & 33) & \omit & -\\
Rate 2 & 2 & 24 & (0 & 67) & \omit & -\\
Rate 3 & 2 & 21 & (0 & 68) & \omit & -\\
Rate 4 & 5 & 36 & (1 & 94) & \omit & -\\
Rate 5 & 4 & 11 & (1 & 19) & \omit & -\\
Rate 6 & 6 & 40 & (2 & 35) & \omit & -\\
Rate 7 & 1 & 62 & (0 & 41) & \omit & -\\
Rate 8 & 0 & 65 & (0 & 21) & \omit & -\\
Rate 9 & 0 & 70 & (0 & 22) & \omit & -\\
\hline
\rule{0pt}{2ex}\relax
outdegree (density)                        & --4 & 37$^{\ast\ast\ast}$ & ( 0 & 26) & --17 & 02\\
reciprocity                                & --3 & 97                  & ( 7 & 73) &  --0 & 51\\
transitive triplets                        &   2 & 98$^{\ast\ast\ast}$ & ( 0 & 84) &    3 & 53\\
3-cycles                                   & --1 & 57                  & ( 5 & 86) &  --0 & 27\\
out-out degree\^(1/2) assortativity         &   0 & 14                  & ( 0 & 40) &    0 & 34\\
devSeniority alter                         & --0 & 00                  & ( 0 & 00) &  --0 & 89\\
devSeniority ego                           &   0 & 00                  & ( 0 & 00) &    1 & 20\\
devSeniority ego x devSeniority alter      & --0 & 00                  & (31 & 61) &  --0 & 00\\
devScActivity alter                        & --0 & 01                  & ( 0 & 01) &  --1 & 04\\
devScActivity ego                          &   0 & 02$^{\ast\ast}$     & ( 0 & 01) &    3 & 02\\
...
$^{\ast\ast\ast}$ $p$ $<$ 0.001;}}\\
\multicolumn{5}{l}
   {\footnotesize{convergence $t$ ratios all $<$ 0.56,}}\\
\multicolumn{5}{l}{\footnotesize{overall maximum convergence ratio 1.38.}}
\label{ans4}
\end{tabular}


\captionof{table}{Estimates parameters in the model for Project Pidgin}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project MPlayer}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project rdesktop}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\multicolumn{5}{l}{\footnotesize{overall maximum convergence ratio 0.23.}}
\label{ans8}
\end{tabular}


\captionof{table}{Estimates parameters in the model for Project freeglut}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project Ceph}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project OpenStack Neutron}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\captionof{table}{Estimates parameters in the model for Project GlusterFS}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
\hline
\rule{0pt}{2ex}\relax
Rate 1 & 4 & 56 & (0 & 74) & \omit & -\\
Rate 2 & 3 & 68 & (0 & 65) & \omit & -\\
Rate 3 & 4 & 61 & (1 & 01) & \omit & -\\
Rate 4 & 6 & 78 & (1 & 50) & \omit & -\\
Rate 5 & 3 & 96 & (0 & 64) & \omit & -\\
Rate 6 & 2 & 70 & (0 & 40) & \omit & -\\
Rate 7 & 2 & 65 & (0 & 51) & \omit & -\\
Rate 8 & 5 & 55 & (1 & 16) & \omit & -\\
Rate 9 & 8 & 19 & (1 & 77) & \omit & -\\
\hline
\rule{0pt}{2ex}\relax
outdegree (density)                        & --2 & 78$^{\ast\ast\ast}$ & ( 0 & 12) & --23 & 25\\
reciprocity                                & --0 & 78                  & ( 0 & 68) &  --1 & 14\\
transitive triplets                        &   2 & 29$^{\ast\ast\ast}$ & ( 0 & 37) &    6 & 15\\
3-cycles                                   & --0 & 88$^\dagger$        & ( 0 & 53) &  --1 & 65\\
out-out degree\^(1/2) assortativity         & --0 & 54$^{\ast\ast}$     & ( 0 & 19) &  --2 & 88\\
devSeniority alter                         & --0 & 00$^{\ast\ast\ast}$ & ( 0 & 00) &  --3 & 38\\
devSeniority ego                           & --0 & 00                  & ( 0 & 00) &  --0 & 13\\
devSeniority ego x devSeniority alter      & --0 & 00                  & (31 & 61) &  --0 & 00\\
devScActivity alter                        & --0 & 09$^\dagger$        & ( 0 & 05) &  --1 & 83\\
...
$^{\ast\ast\ast}$ $p$ $<$ 0.001;}}\\
\multicolumn{5}{l}
   {\footnotesize{convergence $t$ ratios all $<$ 0.45,}}\\
\multicolumn{5}{l}{\footnotesize{overall maximum convergence ratio 0.71.}}
\label{ans12}
\end{tabular}
...
\hline
\rule{0pt}{2ex}\relax
Rate 1 & 4 & 62 & (0 & 78) & \omit & -\\
Rate 2 & 3 & 68 & (0 & 65) & \omit & -\\
Rate 3 & 4 & 68 & (1 & 02) & \omit & -\\
Rate 4 & 6 & 89 & (1 & 54) & \omit & -\\
Rate 5 & 3 & 98 & (0 & 65) & \omit & -\\
Rate 6 & 2 & 70 & (0 & 39) & \omit & -\\
Rate 7 & 2 & 66 & (0 & 52) & \omit & -\\
Rate 8 & 5 & 54 & (1 & 15) & \omit & -\\
Rate 9 & 8 & 29 & (1 & 80) & \omit & -\\
\hline
\rule{0pt}{2ex}\relax
outdegree (density)                        & --2 & 81$^{\ast\ast\ast}$ & ( 0 & 12) & --22 & 61\\
reciprocity                                & --0 & 63                  & ( 0 & 68) &  --0 & 93\\
transitive triplets                        &   2 & 24$^{\ast\ast\ast}$ & ( 0 & 38) &    5 & 85\\
3-cycles                                   & --0 & 78                  & ( 0 & 52) &  --1 & 49\\
out-out degree assortativity         & --0 & 52$^{\ast\ast}$     & ( 0 & 20) &  --2 & 66\\
devSeniority alter                         & --0 & 01$^{\ast\ast\ast}$ & ( 0 & 00) &  --3 & 58\\
devSeniority ego                           &   0 & 00                  & ( 0 & 00) &    0 & 04\\
devSeniority ego x devSeniority alter      & --0 & 00                  & (31 & 61) &  --0 & 00\\
devScActivity alter                        & --0 & 08$^\dagger$        & ( 0 & 05) &  --1 & 65\\
devScActivity ego                          &   0 & 01                  & ( 0 & 04) &    0 & 36\\
devScActivity ego x devScActivity alter    &   0 & 01                  & ( 0 & 01) &    0 & 46\\
int.  devScActivity ego x devSeniority ego &   0 & 00                  & ( 0 & 00) &    0 & 85\\
\hline
\multicolumn{5}{l}{\footnotesize{$^\dagger$ $p$ $<$ 0.1;
$^\ast$ $p$ $<$ 0.05; $^{\ast\ast}$ $p$ $<$ 0.01;
$^{\ast\ast\ast}$ $p$ $<$ 0.001;}}\\
\multicolumn{5}{l}
   {\footnotesize{convergence $t$ ratios all $<$ 0.69,}}\\
\multicolumn{5}{l}{\footnotesize{overall maximum convergence ratio 1.03.}}
\end{tabular}
...
%\hline
%\rule{0pt}{2ex}\relax
%constant friendship rate (period 1) &   6 & 377 & (0 & 927)\\
%constant friendship rate (period 2) &   5 & 015 & (0 & 781)\\
%\hline
%\rule{0pt}{2ex}\relax
%outdegree (density)                 & --2 & 871$^{\ast\ast\ast}$ & (0 & 151)\\
%reciprocity                         &   2 & 747$^{\ast\ast\ast}$ & (0 & 270)\\
%transitive triplets                 &   0 & 897$^{\ast\ast\ast}$ & (0 & 149)\\
%transitive recipr. triplets         & --0 & 548$^\ast$           & (0 & 239)\\
%smoke1 similarity                   &   0 & 226                  & (0 & 207)\\
%drinking alter                      & --0 & 032                  & (0 & 096)\\
%drinking ego                        &   0 & 037                  & (0 & 101)\\
%drinking ego x drinking alter       &   0 & 174$^\ast$           & (0 & 072)\\
%\hline
%\multicolumn{4}{l}{\emph{Behaviour Dynamics}}&\\
%\hline
%\rule{0pt}{2ex}\relax
%rate drinking (period 1)            &   1 & 316 & (0 & 371)\\
%rate drinking (period 2)            &   1 & 798 & (0 & 476)\\
%\hline
%\rule{0pt}{2ex}\relax
%drinking linear shape               &   0 & 414$^\dagger$        & (0 & 237)\\
%drinking quadratic shape            & --0 & 574$^\dagger$        & (0 & 328)\\
%drinking average alter              &   1 & 225                  & (0 & 810)\\
%\hline
%\multicolumn{5}{l}{\footnotesize{$^\dagger$ $p$ $<$ 0.1;
%$^\ast$ $p$ $<$ 0.05; $^{\ast\ast}$ $p$ $<$ 0.01;
%$^{\ast\ast\ast}$ $p$ $<$ 0.001;}}\\
...
%\multicolumn{5}{l}{\footnotesize{Overall maximum convergence ratio 0.16.}}
%\end{tabular}
