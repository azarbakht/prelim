...
\begin{tabular}{p{0.4\textwidth} p{0.48\textwidth} p{0.135\textwidth} p{0.07\textwidth}}
\hline\noalign{\smallskip}
...
\begin{tabular}{m{0.2\columnwidth} m{0.15\columnwidth} m{0.2\columnwidth} m{0.3\columnwidth} m{0.1\columnwidth}}
\hline\noalign{\smallskip}
...
\begin{tabular}{m{0.2\textwidth} m{0.2\textwidth} m{0.1\textwidth} m{0.2\textwidth} m{0.2\textwidth}}
\hline\noalign{\smallskip}
\textbf{Original} & \textbf{Forked} & \textbf{Date} & \textbf{M.L. data available?} & \textbf{Collected?}\\
\noalign{\smallskip}\hline\noalign{\smallskip}
...
Winter/Spring 2015 &  Statistical study, longitidinal modeling & RQ 1-3 \\
