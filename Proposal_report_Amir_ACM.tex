...
\subsubsection{Do forks leave traces in the collaboration artifacts of open source projects in the period leading up to the fork?\\}
...
\subsubsection{What are the key indicators that let us distinguish between different types of forks?\\}
