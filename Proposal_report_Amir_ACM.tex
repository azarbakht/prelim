...
The \textit{population-processes approach} involves statistical modeling of the network, and the following subsection lists the reasons why we need to use a statistical model.
...
\begin{table*} [!Ht]
\centering
\caption{Summary of expectations for the statistical model covariates for each forking category. An expected ``no change'' is denoted by a dash ($-$) line.}
...
Summer 2015 & Statistical analysis & RQ 1-3\\
