...
\item Developer's level of privilege/prestige (e.g. admin privilege-holder vs. core contributor vs. marginal developer/user)
\item Developer's level of negative experience (e.g. number of rejected pull requests: especially in forks for more community-driven development)
\item Developer's age (either birth age, (young 20-year-old developer vs. older 50-year-old developer) or their seniority as a development community member (i.e. how long they have been in the community)
\item Developer's propensity for short-responses vs. long-responses. (under-communicator vs. over-communicator)
\item Developer's communication sentiment (generally bitter in communication known as ``a jerk''), or has a positive communication prose)
\item Developer's engagement style (i.e. dive-bomber-style contributor who jumps in, overcommits and leave, vs. a steady and increasingly engaged contributor who starts off slow and grows his/her commitment gradually)
\end{itemize}
...
\begin{table*}
\centering
\caption{Hypothetical expectations for the statistical model covariates.}
\label{tabelSummaryExpectationModelParameters}       
\begin{tabular}{m{0.3\columnwidth} m{0.15\columnwidth} m{0.15\columnwidth} m{0.15\columnwidth} m{0.15\columnwidth}}
\hline\noalign{\smallskip}
\textbf{Model parameter} & \textbf{U.F. Pers. Dif.} & \textbf{U.F. More Comm.} & \textbf{H.F. Tech. Dif.} & \textbf{No.F.}\\
\noalign{\smallskip}\hline\noalign{\smallskip}
Reciprocity  &  &  &  &  \\ \hline
Transitive triplets & * $\downarrow$ &  &   &   \\ \hline
Number of developers at distance two &  &  &  &  \\ \hline
Density  &  &  &  &  \\ \hline
Covariate-related activity  &  &  &  &  \\ \hline
Preferential Attachment  &  &  &  &  \\ \hline
out-out degree assortativity &  &  &  &  \\ \hline
Developer's level of contribution similarity  &  &  &  &  \\ \hline
Developer's communication sentiment similarity  &  &  &  &  \\ \hline
\noalign{\smallskip}\hline
\end{tabular}
\end{table*}
