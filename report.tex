...
\begin{table} [H]
\caption{The three types of projects for which data is collected in this study}
...
\begin{tabular}{m{0.2\textwidth} m{0.2\textwidth} m{0.15\textwidth} m{0.2\textwidth} m{0.2\textwidth}}
\hline\noalign{\smallskip}
\textbf{Original} & \textbf{Forked} & \textbf{Date} & \textbf{M.L. data available?} & \textbf{Collected?}\\
\noalign{\smallskip}\hline\noalign{\smallskip}
