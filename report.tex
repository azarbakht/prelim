...
There are no statistically significant differences in vectors of means of the actor-oriented model of longitudinal changes of software projects in O.F. category and No.F. category.

\subsubsection{Null Hypothesis \# 3:} 
There are no statistically significant differences in vectors of means of the actor-oriented model of longitudinal changes of software projects in H.F. category and O.F. category.
