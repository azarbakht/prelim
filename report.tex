...
\item{in-in degree assortativity, which reflects }
\item{in-out degree assortativity, which reflects}
\item{out-in degree assortativity, which reflects}
\item{out-out degree assortativity, which reflects}
\end{enumerate}
