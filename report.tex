...
\section{Appendix A: List of all projects forked in U.F. and H.F. Categories}
\label{tablesOfListsOfAllProjects}


\begin{table} [H]
\centering
\caption[List of all projects forked because of ``\textit{personal differences among the developer team}'' (U.F.)]{List of all projects forked because of ``\textit{personal differences among the developer team}'' (U.F.) \cite{Robles} in chronological order. N/A means Unavailable}
...
Sodipodi & Inkscape & 2003, Nov & Yes & N/A\\ \hline
Nucleus CMS & Blog:CMS & 2004, May & Only after Sept 2004 & N/A \\ \hline
BMP & Audacious & 2005, Oct & Yes & N/A \\ \hline
...
\begin{table} [H]
\centering
\caption[List of all projects forked because of the need for ``\textit{more community-driven development}'' (U.F.)]{List of all projects forked because of the need for ``\textit{more community-driven development}'' (U.F.) \cite{Robles} in chronological order. N/A means Unavailable}
