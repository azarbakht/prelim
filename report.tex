...
Network evolution is believed to be too complicated for explicit calculation of probabilities or expected values \cite{Snijders2004}, however, it can be simulated.
