...
\begin{table*}
\centering
\caption{Expectations for significance of the statistical model covariates based on intuition.}
\label{tabelSummaryExpectationModelParameters}       
\begin{tabular}{m{0.4\columnwidth} m{0.15\columnwidth} m{0.1\columnwidth} m{0.1\columnwidth} m{0.08\columnwidth}}
\hline\noalign{\smallskip}
...
Covariate-V1-related popularity  & * &  & * &  \\ \hline
Covariate-V2-related dissimilarity  &  & *- & * &  \\ \hline

Covariate-V3-related popularity  &  & * &  &  \\ \hline
Covariate-V3-related dissimilarity  & * &  &  &  \\ \hline

Covariate-V4-related popularity  & * &  &  &  \\ \hline
Covariate-V4-related dissimilarity  & * & * &  &  \\ \hline

Covariate-V5-related activity  & * &  &  &  \\ \hline
Covariate-V5-related dissimilarity  & * &  &  &  \\ \hline

Covariate-V6-related activity  & * &  &  &  \\ \hline
Covariate-V6-related dissimilarity  & * &  &  &  \\ \hline

Covariate-V7-related activity  & * & *- &  &  \\ \hline
Covariate-V7-related dissimilarity  & * & *- &  &  \\ \hline

Developer's level of contribution similarity  &  &  &  &  \\ \hline
Developer's communication sentiment similarity  &  &  &  &  \\
\noalign{\smallskip}\hline
\end{tabular}
\end{table*}
